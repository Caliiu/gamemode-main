...
Character_Load(playerid, id)
{
	...
	{	
		...
		cache_get_value_name_float(0, "Sede", CharacterData[playerid][e_CHARACTER_HUNGER]);
		cache_get_value_name_float(0, "Fome", CharacterData[playerid][e_CHARACTER_THIRST]);
		cache_get_value_name_float(0, "Fome", CharacterData[playerid][e_CHARACTER_SLEEP]);
...
Character_Save(playerid)
{
	...
	MySQL_TQueryInline(MYSQL_CUR_HANDLE, using inline Character_OnSaved, 
		...
		CharacterData[playerid][e_CHARACTER_SLEEP],
