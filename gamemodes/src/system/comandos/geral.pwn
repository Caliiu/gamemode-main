...
CMD:creditos(playerid, params[])
{
    ...
    SendClientMessage(playerid, COLOR_BEGE, " ");
    SendClientMessage(playerid, COLOR_BEGE, "@Jobim pela criação do gamemode base.");
    SendClientMessage(playerid, COLOR_BEGE, "@Undertaker pela criação de alguns mapas.");
    SendClientMessage(playerid, COLOR_BEGE, " ");
    SendClientMessage(playerid, COLOR_BEGE, "____________________________________________________");
    return 1;
}
