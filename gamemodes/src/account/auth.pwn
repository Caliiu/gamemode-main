...
Auth_ShowDialog(playerid, const err[] = "")
{
	...
	strcat (dialog, "{FFFFFF}Bem-vindo(a) ao {c1241f}Paulista Network{FFFFFF}!\n\n");
	...
	strcat (dialog, "-\tReporte no canal {c1241f}#bug-report{AFAFAF} em nosso Discord: {c1241f}"SERVER_WEBURL"");
