...
CREATE TABLE IF NOT EXISTS `Facções` (
  ...
  `Skin1` int NOT NULL DEFAULT 0,
  `Skin2` int NOT NULL DEFAULT 0,
  `Skin3` int NOT NULL DEFAULT 0,
  `Skin4` int NOT NULL DEFAULT 0,
  `Skin5` int NOT NULL DEFAULT 0,
  `Skin6` int NOT NULL DEFAULT 0,
  `Skin7` int NOT NULL DEFAULT 0,
  `Skin8` int NOT NULL DEFAULT 0,

  `Weapon1` int NOT NULL DEFAULT 0, `Ammo1` int NOT NULL DEFAULT 0,
  `Weapon2` int NOT NULL DEFAULT 0, `Ammo2` int NOT NULL DEFAULT 0,
  `Weapon3` int NOT NULL DEFAULT 0, `Ammo3` int NOT NULL DEFAULT 0,
  `Weapon4` int NOT NULL DEFAULT 0, `Ammo4` int NOT NULL DEFAULT 0,
  `Weapon5` int NOT NULL DEFAULT 0, `Ammo5` int NOT NULL DEFAULT 0,
  `Weapon6` int NOT NULL DEFAULT 0, `Ammo6` int NOT NULL DEFAULT 0,
  `Weapon7` int NOT NULL DEFAULT 0, `Ammo7` int NOT NULL DEFAULT 0,
  `Weapon8` int NOT NULL DEFAULT 0, `Ammo8` int NOT NULL DEFAULT 0,
  `Weapon9` int NOT NULL DEFAULT 0, `Ammo9` int NOT NULL DEFAULT 0,
  `Weapon10` int NOT NULL DEFAULT 0, `Ammo10` int NOT NULL DEFAULT 0
);
