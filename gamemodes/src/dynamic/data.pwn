...
// Constants
#define MAX_INTERACTS 15

#define MAX_ENTRANCES 50

#define MAX_BUSINESS 100
#define MAX_OWNABLE_BUSINESS 3
...
#define MAX_PAINKILLER_DRUGS 	5
#define MAX_BEVERAGE_ALCOHOL	10

#define MAX_INVENTORY_ITEM 35
#define MAX_INVENTORY_DRUG 	10
#define MAX_ROBBERY_MONEY 5000

#define MAX_GAS_PUMP 		20
#define PUMP_OBJECT_MODEL 	1676

#define MAX_FACTIONS 10
#define MAX_FACTION_SKINS 8
#define MAX_FACTION_WEAPONS 10
#define MAX_FACTION_SPAWN 5
#define MAX_FACTION_ARSENAL 5
#define MAX_FACTION_LOCKER 5
#define MAX_LOCKER_SLOTS 20

#define MAX_FURNITURE 				1500
#define MAX_FURNITURE_TEXTURE 		6
#define MAX_FURNITURE_SLOT_REGULAR 	175
#define MAX_FURNITURE_SLOT_BRONZE 	225
#define MAX_FURNITURE_SLOT_SILVER 	275
#define MAX_FURNITURE_SLOT_GOLD 	350
...
enum 
{
	ITEM_CATEGORY_UNUSED,
	ITEM_CATEGORY_GERAL,
	ITEM_CATEGORY_DRUGS,
	ITEM_CATEGORY_BEVERAGES,
	ITEM_CATEGORY_FOOD,
	MAX_ITEM_CATEGORY
}
...
enum
{
	ITEM_SUBCATEGORY_UNUSED,
	ITEM_SUBCATEGORY_DRUG,
	ITEM_SUBCATEGORY_INGREDIENT,
	ITEM_SUBCATEGORY_UTENSIL,
	ITEM_SUBCATEGORY_PACKAGE,
	ITEM_SUBCATEGORY_CASE,
	ITEM_SUBCATEGORY_SEED,
	ITEM_SUBCATEGORY_PAINKILLER,
	ITEM_SUBCATEGORY_BURDEN,
	ITEM_SUBCATEGORY_DRINK,
	ITEM_SUBCATEGORY_FOOD,
	ITEM_SUBCATEGORY_ORDER,
	MAX_ITEM_SUBCATEGORY
}
...
enum
{
	...
	DRUG_TYPE_SMOKABLE,
	DRUG_TYPE_INHALABLE,
	DRUG_TYPE_INJECTABLE,
	DRUG_TYPE_INGESTIBLE,
	MAX_DRUG_TYPE
}
...
enum (<<=1)
{
	...
	DRUG_CASE_SMOKABLE,
	DRUG_CASE_INHALABLE,
	DRUG_CASE_INJECTABLE,
	DRUG_CASE_INGESTIBLE
}

enum (<<=1)
{
	NO_DRUG_EFFECT = 1,
	DRUG_EFFECT_PREVENT_NEED,
	DRUG_EFFECT_SUB_THIRST_30POINTS,
	DRUG_EFFECT_SUB_HUNGER_30POINTS,
	DRUG_EFFECT_SUB_NEEDS_50POINTS,
	DRUG_EFFECT_BROKE_HANDCUFF,
	DRUG_EFFECT_PREVENT_DRUNK,
	DRUG_EFFECT_PREVENT_DRUG_EFFECT,
	DRUG_EFFECT_NON_LHETAL_DECREASE, 
	DRUG_EFFECT_INCREASE_60HP_60S, 
	DRUG_EFFECT_INCREASE_40HP_40S, 
	DRUG_EFFECT_INCREASE_25HP_25S,
	DRUG_EFFECT_DECREASE_10DRUGTIME,
	DRUG_EFFECT_DECREASE_20DRUGTIME,
	DRUG_EFFECT_DECREASE_30DRUGTIME,
	DRUG_EFFECT_DECREASE_40DRUGTIME,
	DRUG_EFFECT_DECREASE_50DRUGTIME,
	DRUG_EFFECT_INCREASE_HUNGER_15,
	DRUG_EFFECT_INCREASE_THIRST_25,
	DRUG_EFFECT_INCREASE_NEEDS_25,
	DRUG_EFFECT_INCREASE_NEEDS_50,
	DRUG_EFFECT_VISUAL,
	DRUG_EFFECT_ADDICTION,
	DRUG_EFFECT_DECREASE_30HP_60S,
	DRUG_EFFECT_DECREASE_50HP_120S,
	DRUG_EFFECT_INCREASE_100HP_60S,
	DRUG_EFFECT_INCREASE_100HP_5S,
	DRUG_EFFECT_INCREASE_75HP_5S,
	DRUG_EFFECT_DECREASE_75HP_120S,
	DRUG_EFFECT_DECREASE_75HP_180S
}

new g_arrItemCategory[MAX_ITEM_CATEGORY][16 + 1] = {
	"Indefinida",
	"Geral",
	"Drug System",
	"Bebidas",
...
new g_arrItemSubCategory[MAX_ITEM_SUBCATEGORY][16 + 1] = {
	"Indefinida",
	"Droga",
	"Ingrediente",
	"Utensílio",
...
new g_arrItemDrugType[MAX_DRUG_TYPE][16 + 1] = {
	"Indefinido",
	"Fumável",
	"Inalável",
	"Injetável",
...
new g_arrItemDrugEffects[][128] = {
	{"{40BF00}+{FFFFFF} Impedir a fome e a sede de aumentarem durante os efeitos"},
	{"{40BF00}+{FFFFFF} Diminuir a sede em 30 pontos"},
	{"{40BF00}+{FFFFFF} Diminuir a fome em 30 pontos"},
	{"{40BF00}+{FFFFFF} Diminuir a fome e a sede em 50 pontos"},
	{"{40BF00}+{FFFFFF} Permitir o uso do /quebraralgema, ao custo de -30% de hp"},
	{"{40BF00}+{FFFFFF} Impedir o Drunkeffect de bebidas alcolicas"},
	{"{40BF00}+{FFFFFF} Atenuar/impedir o efeito negativo do vício em outras drogas"},
	{"{40BF00}+{FFFFFF} Chance de 35 porcento de taser e balas de borrachas não o atingirem durante os efeitos"},
	{"{40BF00}+{FFFFFF} +60hp de forma progressiva (buff de 60 segundos)"},
	{"{40BF00}+{FFFFFF} +40hp de forma progressiva (buff de 40 segundos)"},
	{"{40BF00}+{FFFFFF} +25hp de forma progressiva (buff de 25 segundos)"},
	{"{40BF00}+{FFFFFF} -10% do tempo acumulado de efeitos de drogas"},
	{"{40BF00}+{FFFFFF} -20% do tempo acumulado de efeitos de drogas"},
	{"{40BF00}+{FFFFFF} -30% do tempo acumulado de efeitos de drogas"},
	{"{40BF00}+{FFFFFF} -40% do tempo acumulado de efeitos de drogas"},
	{"{40BF00}+{FFFFFF} -50% do tempo acumulado de efeitos de drogas"},
	{"{FF0000}-{FFFFFF} Aumenta a fome em 15 pontos após o término dos efeitos"},
	{"{FF0000}-{FFFFFF} Aumenta a sede em 25 pontos após o término dos efeitos"},
	{"{FF0000}-{FFFFFF} Aumenta a fome e a sede em 25 pontos após o término dos efeitos"},
	{"{FF0000}-{FFFFFF} Aumenta a fome e a sede em 50 pontos após o término dos efeitos"},
	{"{FF0000}-{FFFFFF} Efeitos visuais"},
	{"{FF0000}-{FFFFFF} Pontos de vício"},
	{"{FF0000}-{FFFFFF} -30hp de forma progressiva (buff de 60 segundos)"},
	{"{FF0000}-{FFFFFF} -50hp de forma progressiva (buff de 120 segundos)"},
	{"{40BF00}+{FFFFFF} +100hp de forma progressiva (buff de 60 segundos)"},
	{"{40BF00}+{FFFFFF} +100hp de forma progressiva (buff de 5 segundos)"},
	{"{40BF00}+{FFFFFF} +75hp de forma progressiva (buff de 5 segundos)"},
	{"{FF0000}-{FFFFFF} -75hp de forma progressiva (buff de 120 segundos)"},
	{"{FF0000}-{FFFFFF} -75hp de forma progressiva (buff de 180 segundos)"}
};
...
enum E_ITEM_DATA
{
	...
	e_ITEM_CATEGORY,
	e_ITEM_SUB_CATEGORY,
	bool:e_ITEM_IS_HEAVY,
	Float:e_ITEM_ATTACH_OFFSET[9],

	// Drogas
	e_ITEM_DRUG_TYPE,
	Float:e_ITEM_DRUG_DOSAGE,
	e_ITEM_DRUG_EFFECTS,
	e_ITEM_DRUG_EFFECT_TIME,
	e_ITEM_DRUG_VISUAL_WEATHER,
	e_ITEM_DRUG_VISUAL_TIME,
	e_ITEM_DRUG_VISUAL_SKIN,
	e_ITEM_DRUG_VISUAL_VEH_COLOR,
	e_ITEM_DRUG_ADDICTION_POINTS,
	bool:e_ITEM_DRUG_LEGAL,

	// Utensílio, Pacote, Invólucro
	e_ITEM_CASE_CAPACITY,
	e_ITEM_CASE_ACCEPT_TYPES,
	e_ITEM_CASE_CIGARRETES,

	// Sementes
	e_ITEM_SEED_AMOUNT,
	e_ITEM_SEED_DRUG_REWARD,
	e_ITEM_SEED_DRUG_REWARD_AMOUNT,
	e_ITEM_SEED_INGREDIENT,
	e_ITEM_SEED_INGREDIENT_PERCENT,
	e_ITEM_SEED_GROWTH_TIME,
	e_ITEM_SEED_MATURING_TIME,
	e_ITEM_SEED_DEATH_TIME,

	// Remédios
	e_ITEM_PAINKILLER_DRUGS[MAX_PAINKILLER_DRUGS],

	// Fardo
	e_ITEM_BURDEN_GENERATE,
	e_ITEM_BURDEN_MAX_GENERATE,

	// Bebidas
	e_ITEM_DRINK_ALCOHOL,
	e_ITEM_DRINK_INDULGE,
	e_ITEM_DRINK_GEN_ITEM,

	// Comidas
	e_ITEM_FOOD_INDULGE,
	e_ITEM_FOOD_GEN_ITEM
}

new ItemData[MAX_ITEMS + 1][E_ITEM_DATA];
...
enum 
{
	INTERACT_TYPE_PREFEITURA,
	INTERACT_TYPE_AGENCIA_EMPREGOS,
	INTERACT_TYPE_ACESSORIOS,
	MAX_INTERACT_TYPE
}

new g_arrInteractNames[MAX_INTERACT_TYPE][32] = {"Prefeitura", "Agência de Empregos", "Acessórios"};

enum E_INTERACT_DATA
{
	bool:e_INTERACT_EXISTS,
	e_INTERACT_AREA,
	e_INTERACT_ICON,
	Text3D:e_INTERACT_LABEL,

	e_INTERACT_ID,
	e_INTERACT_TYPE,
	Float:e_INTERACT_POS[3],
	e_INTERACT_INTERIOR,
	e_INTERACT_WORLD
}

new InteractData[MAX_INTERACTS + 1][E_INTERACT_DATA];
new Iterator:Interacts<MAX_INTERACTS>;
...
{
	bool:e_ENTRANCE_EXISTS,
	e_ENTRANCE_AREA[2],
	e_ENTRANCE_ICON,

	e_ENTRANCE_ID,
	e_ENTRANCE_NAME[32 + 1],
	e_ENTRANCE_ICON_MODEL,
	Float:e_ENTRANCE_POS[3],
	e_ENTRANCE_INTERIOR,
	e_ENTRANCE_WORLD,
	Float:e_ENTRANCE_INSIDE_POS[4],
	e_ENTRANCE_INSIDE_INTERIOR,
	e_ENTRANCE_INSIDE_WORLD
}

new EntranceData[MAX_ENTRANCES + 1][E_ENTRANCE_DATA];
...
new g_arrayFactionTypes[MAX_FACTION_TYPE][] = {"Governo", "Policial", "Médica", "Criminosa"};

enum E_FACTION_DATA
{
	bool:e_FACTION_EXISTS,
	e_FACTION_ID,
	e_FACTION_NAME[32],
	e_FACTION_ABBREV[12],
	e_FACTION_DEFAULT_RANK[32],
	e_FACTION_COLOR,
	e_FACTION_TYPE,
	e_FACTION_VAULT,
	e_FACTION_MOTD[128],
	bool:e_FACTION_BLOCK_CHAT,

	e_FACTION_SKINS[MAX_FACTION_SKINS],       
    e_FACTION_WEAPONS[MAX_FACTION_WEAPONS],   
    e_FACTION_AMMO[MAX_FACTION_WEAPONS],       

	e_FACTION_TIER,
	bool:e_FACTION_TIER_ACTIVE,
	e_FACTION_TIER_UPDATE,
	e_FACTION_TIER_POINTS,
	e_FACTION_TIER_BALANCE,
	e_FACTION_TIER_HOUSE
}

enum E_FACTION_SPAWN_DATA
{
	bool:e_FACTION_SPAWN_EXISTS,
	e_FACTION_SPAWN_ID,
	e_FACTION_SPAWN_NAME[32 + 1],
	Float:e_FACTION_SPAWN_POS[4],
	e_FACTION_SPAWN_WORLD,
	e_FACTION_SPAWN_INTERIOR
}

enum E_FACTION_ARSENAL_DATA
{
	bool:e_FACTION_ARSENAL_EXISTS,
	Text3D:e_FACTION_ARSENAL_LABEL,
	e_FACTION_ARSENAL_ICON,

	e_FACTION_ARSENAL_ID,
	Float:e_FACTION_ARSENAL_POS[3],
	e_FACTION_ARSENAL_WORLD,
	e_FACTION_ARSENAL_INTERIOR
}

enum E_FACTION_LOCKER_DATA
{
	bool:e_FACTION_LOCKER_EXISTS,
	Text3D:e_FACTION_LOCKER_LABEL,
	e_FACTION_LOCKER_ICON,

	e_FACTION_LOCKER_ID,
	Float:e_FACTION_LOCKER_POS[3],
	e_FACTION_LOCKER_WORLD,
	e_FACTION_LOCKER_INTERIOR,

	e_FACTION_LOCKER_ITEMS[MAX_LOCKER_SLOTS],  
    e_FACTION_LOCKER_AMOUNT[MAX_LOCKER_SLOTS]
}

new FactionData[MAX_FACTIONS + 1][E_FACTION_DATA];
new FactionSpawnData[MAX_FACTIONS + 1][MAX_FACTION_SPAWN + 1][E_FACTION_SPAWN_DATA];
new FactionArsenalData[MAX_FACTIONS + 1][MAX_FACTION_ARSENAL + 1][E_FACTION_ARSENAL_DATA];
new FactionLockerData[MAX_FACTIONS + 1][MAX_FACTION_LOCKER + 1][E_FACTION_LOCKER_DATA];
...
{
	VEHICLE_TYPE_TEMP,
	VEHICLE_TYPE_PRIVATE,
	VEHICLE_TYPE_FACTION,
	VEHICLE_TYPE_BUSINESS,
	VEHICLE_TYPE_JOB,
	MAX_VEHICLE_TYPE
}
new g_arrVehicleTypes[MAX_VEHICLE_TYPE][32] = {"Temporário", "Pessoal", "Facção", "Empresarial", "Emprego"};
...
enum E_VEHICLE_DATA
{
	...
	Float:e_VEHICLE_MILEAGE,
	Float:e_VEHICLE_ENGINE_LIFE,
	Float:e_VEHICLE_BATTERY_LIFE,
...
{
	BUSINESS_TYPE_247,
	BUSINESS_TYPE_GUN_STORE,
	BUSINESS_TYPE_CLOTHES_STORE,
	BUSINESS_TYPE_WELL_STACKED,
	BUSINESS_TYPE_VEHICLE_DEALER,
	BUSINESS_TYPE_GAS_STATION,
	BUSINESS_TYPE_FURNITURE,
	BUSINESS_TYPE_PAWN_SHOP,
	BUSINESS_TYPE_JEWELRY,
	BUSINESS_TYPE_BAR,
	BUSINESS_TYPE_CLUB,
	BUSINESS_TYPE_CASINO,
	BUSINESS_TYPE_TOOL_SHOP,
	BUSINESS_TYPE_MECHANIC,
	BUSINESS_TYPE_BURGUER_SHOT,
	BUSINESS_TYPE_CLUCKIN_BELL,
	BUSINESS_TYPE_COFFEE_N_DONUTS,
	BUSINESS_TYPE_RESTAURANT,
	BUSINESS_TYPE_OFFICE,
	BUSINESS_TYPE_ADVERTISE,
	BUSINESS_TYPE_WEED_SHOP,
...
new g_arrBusinessType[MAX_BUSINESS_TYPE][32] = {
	"24/7", 
	"Loja de Armas",
	"Loja de Roupas",
	"Well Stacked",
...
enum E_BUSINESS_DATA
{
	...
	e_BUSINESS_ICON,
	Text3D:e_BUSINESS_LABEL,
	e_BUSINESS_AREA,

	e_BUSINESS_ID,
	e_BUSINESS_OWNER,
	e_BUSINESS_NAME[32],
	e_BUSINESS_MESSAGE[128],
	e_BUSINESS_RADIO[255],
	e_BUSINESS_ENTRANCE_FEE,
	e_BUSINESS_PRICE,
	e_BUSINESS_TYPE,
	e_BUSINESS_VAULT,
	Float:e_BUSINESS_POS[3],
	e_BUSINESS_WORLD,
	e_BUSINESS_INTERIOR,
	Float:e_BUSINESS_INSIDE_POS[4],
	e_BUSINESS_INSIDE_WORLD,
	e_BUSINESS_INSIDE_INTERIOR,
	bool:e_BUSINESS_LOCKED,
	bool:e_BUSINESS_OPEN,

	Float:e_BUSINESS_DEALER_POS[4],

	e_BUSINESS_FUEL,
	e_BUSINESS_FUEL_PRICE,
	e_BUSINESS_PRODUCTS,
	e_BUSINESS_PRODUCT_LIMIT,
	e_BUSINESS_REQUEST_QUANTITY,
	e_BUSINESS_REQUEST_CARGO,
	e_BUSINESS_REQUEST_PRICE
}

new BusinessData[MAX_BUSINESS + 1][E_BUSINESS_DATA];
new Iterator:Business<MAX_BUSINESS>;

/*
	ooooo   ooooo
	`888'   `888'
	 888     888   .ooooo.  oooo  oooo   .oooo.o  .ooooo.   .oooo.o
	 888ooooo888  d88' `88b `888  `888  d88(  "8 d88' `88b d88(  "8
	 888     888  888   888  888   888  `"Y88b.  888ooo888 `"Y88b.
	 888     888  888   888  888   888  o.  )88b 888    .o o.  )88b
	o888o   o888o `Y8bod8P'  `V88V"V8P' 8""888P' `Y8bod8P' 8""888P'
...
enum E_HOUSE_DATA
{
	...
	e_HOUSE_WORLD,
	e_HOUSE_INTERIOR,
	Float:e_HOUSE_INSIDE_POS[4],
	e_HOUSE_INSIDE_WORLD,
	e_HOUSE_INSIDE_INTERIOR,
	Float:e_HOUSE_GARAGE_POS[3],
	e_HOUSE_MONEY,
	bool:e_HOUSE_LOCKED
}

new HouseData[MAX_HOUSES + 1][E_HOUSE_DATA];
...
enum E_GARAGE_DATA
{
	bool:e_GARAGE_EXISTS,
	e_GARAGE_AREA,
	e_GARAGE_ICON,	

	e_GARAGE_ID,
	e_GARAGE_TAX,
	Float:e_GARAGE_POS[3],
	e_GARAGE_WORLD,
	e_GARAGE_INTERIOR,
	Float:e_SPAWN_GARAGE_POS[4],
	e_GARAGE_TYPE,
	e_GARAGE_OWNER_ID
}

new GarageData[MAX_GARAGES + 1][E_GARAGE_DATA];
...
{
	bool:e_INVENTORY_EXISTS,

	e_INVENTORY_ID,
	e_INVENTORY_ITEM,
	e_INVENTORY_ITEM_AMOUNT,
	e_INVENTORY_DRUG_ID[MAX_INVENTORY_DRUG],
	Float:e_INVENTORY_DRUG_AMOUNT[MAX_INVENTORY_DRUG],
	e_INVENTORY_CIGARRETES
}

new InventoryData[MAX_PLAYERS + 1][MAX_INVENTORY_ITEM][E_INVENTORY_DATA];
...
new PumpData[MAX_GAS_PUMP + 1][E_PUMP_DATA];
...
{
	// Link types
	FURNITURE_LINK_TYPE_INVALID = -1,
	FURNITURE_LINK_TYPE_HOUSE,
	FURNITURE_LINK_TYPE_BUSINESS,
	FURNITURE_LINK_TYPE_GARAGE,
	MAX_FURNITURE_LINK_TYPE,

	// Category
	FURNITURE_CAT_ELETRO = 0,
	FURNITURE_CAT_CONFORT,
	FURNITURE_CAT_DECOR,
	FURNITURE_CAT_ENTERTAINMENT,
	FURNITURE_CAT_PLUMBING,
	FURNITURE_CAT_STORAGE,
	FURNITURE_CAT_MISC,
	FURNITURE_CAT_SPECIAL,
	FURNITURE_CAT_EXCLUSIVE,
	MAX_FURNITURE_CATEGORY,

	// Sub categories
	FURNITURE_SUBCAT_REFRIGERATOR = 0,
	FURNITURE_SUBCAT_STOVE,
	FURNITURE_SUBCAT_TRASH_BIN,
	FURNITURE_SUBCAT_SMALL_ELETRO,
	FURNITURE_SUBCAT_TRASH_DEP,
	FURNITURE_SUBCAT_OTHER_ELETRO,
	FURNITURE_SUBCAT_BED,
	FURNITURE_SUBCAT_CHAIR,
	FURNITURE_SUBCAT_ARMCHAIR,
	FURNITURE_SUBCAT_SOFA,
	FURNITURE_SUBCAT_STOOL,
	FURNITURE_SUBCAT_CARPET,
	FURNITURE_SUBCAT_BENCH,
	FURNITURE_SUBCAT_TABLE,
	FURNITURE_SUBCAT_CABINET,
	FURNITURE_SUBCAT_FRAME,
	FURNITURE_SUBCAT_POSTER,
	FURNITURE_SUBCAT_SIGN,
	FURNITURE_SUBCAT_FLAG,
	FURNITURE_SUBCAT_TAGS,
	FURNITURE_SUBCAT_PLANTS,
	FURNITURE_SUBCAT_ILLUMINATION,
	FURNITURE_SUBCAT_STATUE,
	FURNITURE_SUBCAT_DECOR_OTHERS,
	FURNITURE_SUBCAT_SPORT,
	FURNITURE_SUBCAT_TELEVISION,
	FURNITURE_SUBCAT_GAMES,
	FURNITURE_SUBCAT_MEDIA_PLAYER,
	FURNITURE_SUBCAT_STEREO,
	FURNITURE_SUBCAT_PHONE,
	FURNITURE_SUBCAT_MUSIC,
	FURNITURE_SUBCAT_SANITARY,
	FURNITURE_SUBCAT_SINK,
	FURNITURE_SUBCAT_SHOWER,
	FURNITURE_SUBCAT_BATHTUB,
	FURNITURE_SUBCAT_UTENSIL,
	FURNITURE_SUBCAT_BOOKCASE,
	FURNITURE_SUBCAT_LOCKER,
	FURNITURE_SUBCAT_CLOSET,
	FURNITURE_SUBCAT_BEDSIDE_TABLE,
	FURNITURE_SUBCAT_COMFORTABLE,
	FURNITURE_SUBCAT_COUNTERS,
	FURNITURE_SUBCAT_BOOKS,
	FURNITURE_SUBCAT_TRASH,
	FURNITURE_SUBCAT_FOODS,
	FURNITURE_SUBCAT_DRINKS,
	FURNITURE_SUBCAT_KITCHEN,
	FURNITURE_SUBCAT_CLOTHES,
	FURNITURE_SUBCAT_MISC_OTHERS,
	FURNITURE_SUBCAT_DOORS,
	FURNITURE_SUBCAT_WALL_MD,
	FURNITURE_SUBCAT_WALL_LG,
	FURNITURE_SUBCAT_WALL_DOOR,
	FURNITURE_SUBCAT_GLASS,
	FURNITURE_SUBCAT_STAIR,
	FURNITURE_SUBCAT_FENCE,
	FURNITURE_SUBCAT_DRUG_SYSTEM,
	FURNITURE_SUBCAT_XMAS,
	FURNITURE_SUBCAT_HALLOWEEN,
	FURNITURE_SUBCAT_GARAGE,
	MAX_FURNITURE_SUBCAT
}

enum E_FURNITURE_SUBCATEGORY
{
	e_FURNITURE_SC_CATEGORY,
	e_FURNITURE_SC_ID,
	e_FURNITURE_SC_NAME[32]
}

enum E_FURNITURE_SHOP
{
	e_FURNITURE_SHOP_CATEGORY,
	e_FURNITURE_SHOP_SUBCATEGORY,
	e_FURNITURE_SHOP_NAME[64 + 1],
	e_FURNITURE_SHOP_MODEL,
	e_FURNITURE_SHOP_PRICE
}
...
enum E_TEXTURE_DATA 
{
	...
	e_TEXTURE_OBJECT,
	e_TEXTURE_LIB[64],
	e_TEXTURE_SUB_LIB[64]
};

enum E_FURNITURE_DATA
{
	bool:e_FURNITURE_EXISTS,
	e_FURNITURE_OBJECT,

	e_FURNITURE_ID,
	e_FURNITURE_NAME[64],
	e_FURNITURE_MODEL,
	e_FURNITURE_TEXTURE[MAX_FURNITURE_TEXTURE],
	e_FURNITURE_TEXTURE_COLOR[MAX_FURNITURE_TEXTURE],
	Float:e_FURNITURE_POS[3],
	Float:e_FURNITURE_ROT[3],
	bool:e_FURNITURE_DOOR_LOCKED,
	bool:e_FURNITURE_DOOR_OPENNED,
	Float:e_FURNITURE_DOOR_POS[3],
	Float:e_FURNITURE_DOOR_ROT[3],
	e_FURNITURE_PRICE,
	e_FURNITURE_LINK_TYPE,
	e_FURNITURE_LINK_ID
}

new Iterator:Furnitures<MAX_FURNITURE>;
new FurnitureData[MAX_FURNITURE + 1][E_FURNITURE_DATA];

new const g_aColors[][E_TEXTURE_COLOR_DATA] = {
    {"Branco", 		0xFFB0C0CD},
	{"Vermelho",  	0xFF8A3A3B},
	{"Azul", 		0xFF0202BC},
	{"Laranja", 	0xFF9B5E05},
...
new const g_aTextures[][E_TEXTURE_DATA] = {
	{ "", 0, "INVALID", "INVALID" },
	...
	{"Mogno padrão", 16377, "des_byofficeint", "CJ_WOOD5"},
	{"Madeira de pinheiro", 13007, "sw_bankint", "woodfloor1"},
	{"Mogno escuro", 11631, "mp_ranchcut", "mpCJ_WOOD_DARK"},
	{"Madeira branca", 3587, "snpedhusxref", "sjmlawood2"},
	{"Placas de madeira branca", 1219, "woodpanels", "planks01"},
	{"Madeira envelhecida", 916, "crates_n_stuffext", "CJ_SLATEDWOOD"},
	{"Painel de madeira", 17566, "contachou1_lae2", "mp_apt1_woodpanel"},
	{"Madeira envernizada", 6404, "beafron1_law2", "Gen_Scaffold_Wood_Under"},
	{"Parede de bar", 8565, "vgsebuild01", "GB_nastybar03"},
	{"Piso xadrez", 16150, "ufo_bar", "dinerfloor01_128"},
	{"Parede simples", 9947, "lombard", "lombard_build2_5"},
	{"Parede simples c/ janela 1", 9947, "lombard", "lombard_build2_3"},
	{"Parede simples c/ janela 2", 9947, "lombard", "lombard_build2_4"},
	{"Vidro downtown", 4877, "downtown1_las", "GB_nastybar14"},
	{"Tijolos vermelhos 1", 8678, "wddngchplgrnd01", "vgschapelwall01_128"},
	{"Tijolos vermelhos 2", 3646, "ganghouse1_lax", "brick"},
	{"Tijolo marrom", 9495, "vict_sfw", "newall10_seamless"},
	{"Tijolos brancos", 8399, "vgs_shops", "vgsclubwall05_128"},
	{"Tijolo cinza", 8401, "vgshpground", "vegaspawnwall02_128"},
	{"Pedras 1", 8839, "vgsecarshow", "sw_wallbrick_06"},
	{"Pedras 2", 6056, "venice_law", "stonewall_la"},
	{"Calçada vermelha", 9947, "lombard", "lombard_sfe"},
	{"Metal", 5397, "barrio1_lae", "metpat64"},
	{"Grama 1", 9495, "vict_sfw", "Grass_128HV"},
	{"Grama 2", 10931, "traingen_sfse", "desgreengrass"},
	{"Piso de banheiro", 12853, "cunte_gas01", "sw_floor1"},
	{"Metal area 51", 16644, "a51_detailstuff", "a51_floorpanel1"},
	{"Duas portas", 18265, "w_town3cs_t", "inddoor5"},
	{"Porta pichada", 18200, "w_town2cs_t", "Bow_door_graffiti_128"},
	{"Roupas no varal", 4891, "wiresetc_las", "clothline1_LAe"},
	{"Graffiti 1", 5150, "wiresetc_las2", "cleargraf02_LA"},
	{"Graffiti 2", 4227, "graffiti_lan01", "cleargraf01_LA"},
	{"Graffiti 3", 8399, "vgs_shops", "vegasclub01_128"},
	{"Graffiti 4", 8399, "vgs_shops", "vegasclub02_128"},
	{"Quadricolor", 1676, "wshxrefpump", "petrolpumptop_128"},
	{"Varrio graffiti 1", 5134, "wasteland_las2", "mural05_LA"},
	{"Varrio graffiti 2", 5142, "lashops1b_las2", "mural03_LA"},
	{"Santa Madre", 4849, "ground3_las", "mural01_LA"},
	{"Azteca Mural", 5407, "glenpark1x_lae", "mural06_LA"},
	{"Mexican Girl", 17504, "eastlstr_lae2", "mural07_LA"},
	{"Bobo Sign", 5174, "warehus_las2", "bobo_3"},
	{"Mato", 8825, "vgsestriphedge", "newhedgea"},
	{"Veludo de caramelo", 8463, "vgseland", "tiadbuddhagold"},
	{"Estampa", 8463, "vgseland", "triadcarpet"},
	{"Parede gang", 8567, "vgsebuild02", "vgsderelict01_128"},
	{"Madeira ruim", 12980, "sw_block10", "sw_woodwall1"},
	{"Gun Board", 10631, "queensammo_sfs", "ammu_gunboard3"},
	{"US Flag 1", 3310, "sw_poorhouse", "sw_flag01"},
	{"US Flag 2", 9593, "hosbibalsfw", "dt_cops_US_flag"},
	{"US Flag 3", 11008, "firehouse_sfse", "ws_usflagcrumpled"},
	{"Gay Flag", 3853, "gay_xref", "ws_gayflag2"},
	{"Piso frio", 11301, "carshow_sfse", "concreteslab_small"},
	{"Piso frio vermelho", 8391, "ballys01", "ws_floortiles4"},
	{"Station floor", 5772, "stationtunnel", "mp_apt1_bathfloor1"},
	{"Bakery Wall", 10891, "bakery_sfse", "ws_altz_wall4"},
	{"China Wall 1", 9494, "chinatownsfe", "sf_windos_11wall"},
	{"China Wall 2", 9494, "chinatownsfe", "sf_windos_12_wall"},
	{"Parede metralhada", 13131, "cunte_blockammo", "dt_ammu_wall2"},
	{"Azul vivo", 8839, "vgsecarshow", "lightblue2_32"},
	{"Verde vivo", 8839, "vgsecarshow", "lightgreen2_32"},
	{"Cinza vivo", 8839, "vgsecarshow", "lightblue_64"},
	{"Roxo vivo", 8839, "vgsecarshow", "lightpurple2_32"},
	{"Vermelho vivo", 8839, "vgsecarshow", "lightred2_32"},
	{"Amarelo vivo", 8839, "vgsecarshow", "lightyellow2_32"},
	{"Chroma Key", 8839, "vgsecarshow", "lightgreen2_32"},
	{"Branco vivo", 16150, "ufo_bar", "GEwhite1_64"},
    {"Água", 3947, "rczero_track", "waterclear256"},
	{"Carpete vermelho", 10412, "hotel1", "carpet_red_256"},
	{"Parede de tijolos vermelho", 18265, "w_town3cs_t", "ws_redbrickold"},
	{"Céu azul c/ nuvens", 3925, "weemap", "skyclouds"},
	{"Chão de madeira clara", 18265, "w_town3cs_t", "boardwalk_la"},
	{"Vidro quadrado", 8556, "vgsehseing1", "marinawindow1_256"},
	{"Vidro retangular", 9106, "vgeamun", "gallery01_law"},
	{"Parede de pedras", 6056, "venice_law", "stonewalls2"},
	{"Parede de tijolos claros", 8390, "vegasemulticar", "ws_mixedbrick"},
	{"Madeira mogno", 16154, "ufo_barbakroom", "btdeck256"},
	{"Madeira mogno p/ balcão", 16150, "ufo_bar", "sa_wood08_128"},
	{"Madeira clara p/ balcão", 16150, "ufo_bar", "sa_wood07_128"},
	{"Piso de azulejos amarelos e azuis", 5408, "tempstuff_lae", "exambal1_LAe"},
	{"Madeira virgem p/ balcão", 12954, "sw_furniture", "ws_sheetwood_clean"},
	{"Parede de tijolos deitados escuros", 10053, "slapart01sfe", "sl_vicbrikwall01"},
	{"Vidro quadrado marrom", 3979, "civic01_lan", "sl_laglasswall1"},
	{"Piso de celeiro", 12911, "sw_farm1", "sw_barnfloor1"},
	{"Piso madeirado marrom médio", 5134, "wasteland_las2", "floorboard256128"},
	{"Parede de piscina", 13675, "lahillsgrounds", "bevpool"},
	{"Parede Azul Velha", 13694, "lahillstxd1a", "bluemetal02"},
	{"Marmore braco", 3922, "bistro", "Marble2"},
	{"Marmore Cinza", 5723, "lee_stripclub", "Strip_ceiling"},
	{"Marmore Azul Escuro", 6351, "rodeo02_law2", "helmutwall1_LAw"},
	{"Tijolos Bege", 11008, "firehouse_sfse", "GB_sandstwall0"},
	{"Marmore Azulado", 3979, "civic01_lan", "sl_laglasswall2"},
	{"Vidros para Janelas", 13701, "lahillshilhs1c", "mirrwind4_LAn"},
	{"Monitores de Cameras", 16644, "a51_detailstuff", "a51_monitores"},
	{"Porta Elevador", 10023, "bigwhitesfe", "liftdoors_kb_256"},
	{"Marmore Cinza 2", 10871, "blacksky_sfse", "ws_slatetiles"},
	{"Bandeira EUA", 12853, "cunte_gas01", "starspangban1_256"},
	{"Concreto do aeroporto", 10765, "airportgnd_sfse", "ws_airpt_concrete"},
	{"Parede de tijolos laranjas", 3603, "bevmans01_la", "cemebuild03_law"},
	{"Parede preta", 3975, "lanbloke", "p_floor3"},
	{"Vidro De Espelho", 1649, "wglass", "carshowwin2"},
	{"Camuflagem Azul", 10631, "queensammo_sfs", "ammu_camo1"},
	{"Camuflagem Deserto", 3267, "milbase", "sam_camo"},
	{"Zebra Skin", 14446, "carter_block", "zebra_skin"},
	{"Branco creme", 18200, "w_town2cs_t", "mottled_creme_64HV"},
	{"Calçada Branca",10789, "xenon_sfse", "ws_white_wall1"},
	{"Branco rosado", 8401, "vgshpground", "vegaspawnwall_128"},
	{"Branco simples", 8954, "vgsespras", "sf_spray1"},
	{"Esfinge", 8396, "sphinx01", "sphinxface01_256"},
	{"Mural egípcio", 8396, "sphinx01", "luxormural01_256"},
	{"Mural luxuoso", 8396, "sphinx01", "luxorledge02_128"},
	{"Branco granito", 8396, "sphinx01", "sphinxbody01_128"},
	{"Azul granito", 8396, "sphinx01", "	luxorceiling02_128"},
	{"Ocre granito", 8396, "sphinx01", "luxorceiling01_128"},
	{"Parede vermelha clara", 6354, "sunset03_law2", "comptwall36"},
	{"Parede tijolos marrom e branco", 5180, "lashops93_las2", "sanpedton1"},
	{"Parede concreto e pedras", 17517, "templae2land", "lostonclad1"},
	{"Telhas", 6294, "santamonhus", "shingles2"},
	{"Mosaico pavimentado", 10926, "shops_sfse", "pavetilealley256128"},
	{"Parede de rancho", 11430, "des_sw", "des_ranchwall1"},
	{"Pavimentação", 4821, "union_las", "crazypave"},
	{"Concreto escuro e liso", 13008, "sw_block01", "Bow_Concrete_drip"},
	{"Parede clara de tijolos", 18202, "w_towncs_t", "ahoodfence2"},
	{"Parede cinza e verde", 8401, "vgshpground", "parkinghut01_128"},
	{"Parede amarela clara e escura", 9169, "vgslowbuild", "curbyell_64H"},
	{"Parede branca e vermelha", 9169, "vgslowbuild", "cj_S_POLE"},
	{"Parede de listra azul e vermelha", 9169, "vgslowbuild", "vgnstripwal1_128"},
	{"Parede listrada azul e branco", 8494, "vgslowbuild1", "vgnmetalwall1_256"},
	{"Parede bege com listras coloridas", 8495, "vgsmall", "vgncarwash3_256"},
	{"Grade azul e amarela", 8572, "vgssstairs1", "gridchev_64HV"},
	{"Parede branca de cerca azul", 8399, "vgs_shops", "vegasclubledge_128"},
	{"Parede de tijolos clara", 8839, "vgsecarshow", "sw_wallbrick_06"},
	{"Mogno escuro de balcão de bar", 9029, "vgetrainfnce", "GB_nastybar05"},
	{"Parede de tijolos azul e vermelho", 8565, "vgsebuild01", "badhousewall07_128"},
	{"Tijolos claros e misturados", 8390, "vegasemulticar", "ws_mixedbrick"},
	{"Parede de depósito", 17072, "truckedepotlawn", "GB_truckdepot02"},
	{"Parede de estúdio de TV", 6490, "tvstudio_law2", "tvstud02_LAw2"},
	{"Rochas claras", 16150, "ufo_bar", "stonewall2_la"},
	{"Rochas cinzas", 6056, "venice_law", "stonewall_la"},
	{"Parede do metrô", 3167, "trailers", "trail_wall4"},
	{"Tijolos acizentados", 12986, "sw_well1", "cobbles_kb_256"},
	{"Metal e madeira", 1306, "telegraph", "metatelepole1"},
	{"Madeira de poste", 1306, "telegraph", "telepole2128"},
	{"Parede de galpão", 12925, "sw_sheds", "sw_shedwall03"},
	{"Tecido rústico", 13002, "sw_smlfarm", "Gen_Rusty_Poll"},
	{"Telha de lousa", 12911, "sw_farm1", "sw_slate01"},
	{"Chapa de metal com listras", 12911, "sw_farm1", "ws_corrugated3"},
	{"Chapa de tambor velho", 12911, "sw_farm1", "sw_olddrum1"},
	{"Parede clara de tijolos finos", 13015, "sw_genstore", "sw_wallbrick_03"},
	{"Parede escura de tijolos finos", 12959, "sw_library", "sw_brick05"},
	{"Telhado com musgo", 12937, "sw_oldshack", "sw_cabinroof"},
	{"Metal enferrujado", 12937, "sw_oldshack", "sw_cabshut01"},
	{"Cercado de madeira clara", 3310, "sw_poorhouse", "sw_lattice"},
	{"Parede com listra vermelha", 13296, "sw_roadgas", "a51_wall1"},
	{"Parede clara de pedregulhos", 12979, "sw_block9", "sw_wall03"},
	{"Parede azul com madeira", 13007, "sw_bankint", "bank_wall1"},
	{"Chão de metal enferrujado", 13007, "sw_bankint", "spad_tile5_256"},
	{"Parede x3", 12923, "sw_block05", "sw_walltopx3"},
	{"Parede azul com tiras brancas", 12964, "sw_block09", "ablusrip"},
	{"Parede cinza de tijolos finos", 9495, "vict_sfw", "newall10_seamless"},
	{"Parede de Melrose", 5765, "sunsetbittyu", "melrbr02_law"},
	{"Tijolos finos escuros", 5870, "sunst18_lawn", "laspowrec2"},
	{"Parede de azulejos", 5870, "sunst18_lawn", "tiledwall01_LA"},
	{"Parede preta com madeira", 13007, "sw_bankint", "bank_wall4"},
	{"Parede de estúdio de TV 2", 13014, "sw_block04", "studiowall2_law"},
	{"Parede verde com tiras claras", 5727, "sunrise04_lawn", "fredwall2_LAwN"},
	{"Parede lisa com faixa escura", 4570, "stolenbuild03", "sl_dtbuild2wall1"},
	{"Chão escuro felpudo", 3975, "lanbloke", "p_floor3"},
	{"Parede de tijolos finos mesclada", 10053, "slapart01sfe", "sl_vicbrikwall01"},
	{"Tela quadriculada azul e cinza", 4550, "skyscr1_lan2", "ablndwall2_LAE"},
	{"Parede azul com faixa branca", 6095, "shops01_law", "GB_chatwall03b"},
	{"Parede de tijolos com musgo", 10938, "skyscrap_sfse", "ws_altz_wall6big"},
	{"Parede Downtown marrom", 9906, "sfe_builda", "sl_dwntwallvic1"},
	{"Muro com tijolos quebrados", 18365, "sawmillcs_t", "ws_rottenwall"},
	{"Parede azul com faixas branca e vermelha", 6287, "pierc_law2", "beachwall7_256"},
	{"Parede laranja com faixa marrom", 8496, "lowbuild03_lvs", "vgshopwall02_128"},
	{"Muro de tijolos marrom com faixa branca", 3749, "law2misc_lax", "cemewall01_law"},
	{"Muro de tijolos redondos", 4807, "lasroads_las", "retainwall1"},
	{"Parede bege lisa com bordado", 9300, "gazsfn1", "lawshopwall4c"},
	{"Parede bege lisa", 3759, "venchouse_lax", "lawshopwall4"},
	{"Parede lisa roxa", 4551, "sunset1_lan2", "snpedpurtrm"},
	{"Parede verde de mosaico", 5769, "sunrise09_lawn", "mosaic1_LAwn"},
	{"Parede azul de mosaico", 5727, "sunrise04_lawn", "mosaic2_LAwn"},
	{"Parede azul escuro de mosaico", 4101, "stapl", "sl_Laexpowin2"},
	{"Parede azul claro de mosaico", 4101, "stapl", "sl_laexpowin1"},
	{"Parede de tijolos laranja com bordado", 5722, "sunrise01_lawn", "tileshoptop1_law"},
	{"Madeira edge", 3900, "station", "ledge2_64H"},
	{"Madeira rustica clara", 3900, "station", "rustd64"},
	{"Madeira rustica acizentada", 8867, "vgsecnstrct01", "girder2_grey_64HV"},
	{"Parede fria", 10971, "stadjunct_sfse", "ws_freeway1"},
	{"Muro de tijolos laranjas", 9908, "smallertxd", "pier69_planter"},
	{"Parede rosa com listras", 3587, "snpedhusxref", "sjmlahus23"},
	{"Parede rosa com listras brancas", 10061, "simcondo_sfe", "sl_hiriserail1"},
	{"Parede verde com listras brancas", 10061, "simcondo_sfe", "sl_hiriserail2"},
	{"Metal area 51", 16640, "a51", "sl_metalwalk"},
	{"Parede de tijolos brancos e marrom", 6282, "beafron2_law2", "sanpiz1"},
	{"Parede de madeira azul", 13721, "mulhousclahills", "sanpednhus1r"},
	{"JANELA 1", 13721, "mulhousclahills", "newindow13"},
	{"JANELA 2", 16093, "a51_ext", "wilswin01_la"},
	{"Piso Granito branco", 10765, "airportgnd_sfse", "sf_pave2"},
	{"Tijolos cinza simples", 4552, "ammu_lan2", "sl_lavicdtwall1"},
	{"Piso/parede de madeira simples", 3615, "Cabana de praia   ", "ws_decking1"},
	{"JANELA 3", 6284, "bev_law2", "comptwindo2"},
	{"Madeira alaranjada", 3922, "bistro", "DinerFloor"},
	{"Marmore escuro", 3922, "bistro", "Mármore"},
	{"Madeira simples", 3881, "apsecurity_sfxrf", "CJ_WOOD1"},
	{"Amarelo Granito", 8538, "vgsrailroad", "concreteyellow256 copy"},
	{"Chão Cinza", 10838, "airwelcomesign_sfse", "ws_oldpainted"},
	{"Verde Granito", 16434, "des_stwnsigns1", "dustyjade_128"},
	{"Azul Listrado", 17553, "ebeachcineblok", "stripsign_lae2"},
	{"Vermelho Granito", 8620, "excalibursign", "excalibur05_64"},
	{"Verde Escuro Granito", 11145, "carrierint_sfs", "ws_floor2"},
	{"Madeira de balcão Bar", 16150, "ufo_bar", "woodboards1"},
	{"Janela Banheiro", 4550, "skyscr1_lan2", "sl_librarycolmn1"},
	{"Janela 4", 10789, "xenon_sfse", "newindow4"},
	{"Vidro Colorido", 3922, "bistro", "StainedGlass"},
	{"Textura Grade", 18202, "w_towncs_t", "Upt_Fence_Mesh"},
	{"Metal de Container", 10789, "xenon_sfse", "corugwall2-1"},
	{"Metal Simples", 3673, "xrf_refineryla", "Metal3_128"},
	{"Metal Simples 2", 16150, "ufo_bar", "metalic128"},
	{"Parede Mosaico Branco", 13724, "docg01_lahills", "ws_stationfloor"},
	{"Piso Cinza quadrado", 13701, "lahillshilhs1c", "man_cellarfloor128"},
	{"Poster filme Discharger", 13761, "lahills_whisky", "discharger"},
	{"Metal Aluminio", 16640, "a51", "Metal3_128"},
	{"Teto Quadrado", 16639, "a51_labs", "ws_trainstationwin1"},
	{"Piso Quadrado Cinza", 10765, "airportgnd_sfse", "sf_pave2"},
	{"Quadro ponte Vermelha SF", 10838, "airwelcomesign_sfse", "ws_airwelcome1"},
	{"Agua 2", 8487, "ballyswater", "waterclear256"},
	{"Jogo de Paciencia", 1515, "dsfs", "CJ_POKERSCREEN88"},
	{"Madeira Marcada", 8536, "tikisign", "tikireed01_128"},
	{"Agua 3", 16646, "a51_alpha", "waterdirty256"},
	{"Portão de Ferro", 13699, "cunte2_lahills", "laposhfence3"},
	{"Quadrado de Vidro", 13724, "docg01_lahills", "glassblock4_law"},
	{"Piso Quadrado 2", 16639, "a51_labs", "dam_terazzo"},
	{"Papel de Parede Branco e Vermelho", 4552, "    ammu_lan2", "sunsetammu2"},
	{"Parede Bege", 4001, "civic03_lan", "twintWall2_LAn"},
	{"Xadrez Cinza", 12844, "cos_liquorstore", "b_wtilesreflect"}
};

new const g_aFurnitureCategory[MAX_FURNITURE_CATEGORY][16 + 1] = {
 	{"Eletrodomésticos"},
	{"Conforto"},
	{"Decoração"},
	{"Entretenimento"},
...
new const g_aFurnitureSubCategory[][E_FURNITURE_SUBCATEGORY] = {
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Refrigeradores"},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogões"},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeiras"},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Pequenos eletrodomésticos"},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_DEP, "Depósitos de lixo"},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Outros eletro-eletrônicos"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Camas"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_CHAIR, "Cadeiras"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_ARMCHAIR, "Poltronas"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_SOFA, "Sofás"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_STOOL, "Banquinhos"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_CARPET, "Tapetes"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BENCH, "Bancos"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_TABLE, "Mesas"},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_CABINET, "Gabinetes"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_FRAME, "Quadros"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_POSTER, "Posters"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_SIGN, "Placas"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_FLAG, "Bandeiras"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_TAGS, "Tags"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Plantas"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Iluminação"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_STATUE, "Estatuas"},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Outros"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Equipamentos de esporte"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisões"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "Máquinas de jogos"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Mídia players"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Stereo"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Telefones"},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Música"},
	{FURNITURE_CAT_PLUMBING, FURNITURE_SUBCAT_SANITARY, "Sanitários"},
	{FURNITURE_CAT_PLUMBING, FURNITURE_SUBCAT_SINK, "Pias"},
	{FURNITURE_CAT_PLUMBING, FURNITURE_SUBCAT_SHOWER, "Chuveiros"},
	{FURNITURE_CAT_PLUMBING, FURNITURE_SUBCAT_BATHTUB, "Banheiras"},
	{FURNITURE_CAT_PLUMBING, FURNITURE_SUBCAT_UTENSIL, "Utilitários"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_BOOKCASE, "Estantes"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_LOCKER, "Armários"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_CLOSET, "Guarda-roupas"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_BEDSIDE_TABLE, "Criados-mudos"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_COMFORTABLE, "Cômodas"},
	{FURNITURE_CAT_STORAGE, FURNITURE_SUBCAT_COUNTERS, "Balcões"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_BOOKS, "Papéis e Livros"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_TRASH, "Sujeira e lixo"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_FOODS, "Comidas"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_DRINKS, "Bebidas"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_KITCHEN, "Cozinha"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_CLOTHES, "Roupas"},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Outros"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_DOORS, "Portas"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_WALL_MD, "Paredes (médias)"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_WALL_LG, "Paredes (grandes)"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_WALL_DOOR, "Paredes (aberturas p/ porta)"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_GLASS, "Vidros"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_STAIR, "Escadas"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cercas"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_DRUG_SYSTEM, "Drug System"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Natal"},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Halloween"},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Garagem"}
};

new const g_aFurnitureShop[][E_FURNITURE_SHOP] = {
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Geladeira normal", 2147, 250},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Geladeira grande vermelho", 2127, 300},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Refrigerador horizontal quadrado", 2360, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Refrigerador horizontal redondo", 2361, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Refrigerador de inox", 1780, 350},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Geladeira Premium", 19916, 400},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Geladeira cooler", 1990, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_REFRIGERATOR, "Freezer com Vidro", 2443, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão branco", 19933, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão Sterlin Co.", 2135, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão Maggies Co.", 2017, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão vermelho inox", 2294, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão antigo de ferro", 2294, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão pequeno", 2144, 130},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão velho escuro com saida de ar", 1773, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão velho escuro", 1777, 90},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão velho branco", 19915, 90},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão Fryer", 2415, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_STOVE, "Fogão Cooker", 2417, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeira detonada", 1347, 30},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeira de plástico", 1343, 5},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeira sucateada", 1362, 10},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeira de comida", 1574, 5},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_BIN, "Lixeira pequena de metal", 1359, 20},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Microondas pequeno", 2149, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Microondas grande", 2421, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Liquidificador", 19830, 130},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Máquina de Refrigerante", 2500, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Refrigerador de Água 1", 1808, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Refrigerador de Água 2", 2002, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Exaustor", 19924, 300},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Máquina de cerveja de balcão 1", 1511, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Máquina de cerveja de balcão 1", 1488, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Cafeteira", 11743, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Telefone", 19874, 60},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Telefone de discar", 11705, 40},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Lavadora de pratos", 1208, 300},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_SMALL_ELETRO, "Forno de Pizza", 2426, 50},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_DEP, "Depósito de rua normal", 1344, 15},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_DEP, "Depósito compacto preto", 1345, 10},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_TRASH_DEP, "Depósito normal com lixo", 1415, 15},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Máquina de lavar roupas", 1208, 250},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Ventilador de Teto", 1661, 130},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Aquecedor", 1738, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Balde e Esfregão", 1778, 70},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Cofre", 1829, 150},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Impressora", 2186, 80},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Computador", 2190, 200},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Ar condicionado pra o lado de fora", 1618, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Saída de Ar", 914, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Ventilador de Teto 2", 16780, 50},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Luminária Elétrica Mata-Mosquitos", 2718, 100},
	{FURNITURE_CAT_ELETRO, FURNITURE_SUBCAT_OTHER_ELETRO, "Computador de mecanica", 19903, 150},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama pink queen", 1700, 200},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama royal brown queen", 1725, 230},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama white and green queen", 1745, 350},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Pilha de colchões", 1793, 70},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama brown wooden queen", 1794, 250},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de praia básica", 1795, 150},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama single brown wooden", 1796, 130},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama stylish legs", 1797, 150},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de cadeia ferro", 1771, 50},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de praia single", 1798, 100},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama brown quilted yellow queen", 1799, 150},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de cadeia metal", 1800, 80},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama white wooden", 1801, 200},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama quilt wooden floral", 1802, 170},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de prisão fraca", 1812, 30},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama madeira em fita", 2090, 100},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama quilt wooden floral single", 1803, 150},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de cabana", 2302, 120},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de casal com bidês 1", 2566, 200},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama de casal com bidês 2", 2575, 225},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Duas camas de casal com bidês", 2565, 300},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "Cama king size zebra", 14446, 400},
	{FURNITURE_CAT_CONFORT, FURNITURE_SUBCAT_BED, "
 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Palmeira morta em vaso", 14834, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Flores em vaso de parede", 3802, 25},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Planta em vaso de parede", 3810, 25},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Pequeno Cacto", 2194, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Plantas em vaso de concreto 1", 637, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Plantas em vaso de concreto 2", 638, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Plantas em vaso de concreto 3", 640, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Plantas caindo da parede", 639, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Pilha de vasos de planta", 1807, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Flores de jardim 2", 8990, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Flores de jardim", 869, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_PLANTS, "Planta de LED", 2176, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada delicada", 2707, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur com várias lâmpadas", 2239, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur foguete", 2238, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur de escritório", 2196, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur grande 1", 2108, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur grande 2", 2069, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur grande 3", 2023, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur cogumelo 1", 2107, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur cogumelo 2", 2106, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur cogumelo 3", 2105, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Abajur cogumelo 4", 2077, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 1", 2076, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 2", 2075, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 3", 2074, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 4", 2073, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 5", 2026, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 6", 1893, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de teto 7", 1734, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lustre", 11726, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lustre 2", 19806, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Ventilador de teto", 1657, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de parede 1", 1731, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Lâmpada de parede 2", 3785, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Holofote", 19147, 30},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_ILLUMINATION, "Ventilador de teto 2", 16779, 200},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_STATUE, "Estátua assustada", 2745, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_STATUE, "Estátua de anjo", 3462, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_STATUE, "Estátua de leão", 3471, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_STATUE, "Estátua negro obeso", 14467, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cabeça de Alce", 1736, 100},
 	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cesta de Basquete de parede", 3497, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Projeto de Arquitetura", 3111, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Disco Roxo de Parede", 1962, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Disco Verde de Parede", 1963, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Disco Rosa de Parede", 1964, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Tomada Marrom", 19813, 3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Tomada Branca", 19814, 3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Relógio de Parede", 19825, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Interruptor Velho", 19826, 3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Interruptor Branco", 19827,3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Interruptor Horizontal", 19828, 3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Vidro vermelho de incêndio", 2961, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Vidro preto de incêndio", 2962, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Vidro preto de incêndio", 2962, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Alarme de incêndio", 1613, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Alarme", 1615, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Alarme 2", 1614, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Duto de Ventilação", 1620, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Brinquedos de Parede 1", 2504, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Brinquedos de Parede 2", 2503, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Brinquedos de Parede 3", 2501, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Roleta de Parede 1", 1895, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Roleta de Parede 2", 1929, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Prateleira Branca 1", 2475, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Prateleira Branca 2", 2463, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Prateleira Branca 3", 2462, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Prateleira de Madeira", 1744, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Prateleira de Metal", 2553, 15},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Disco de Ouro", 19617, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Espelho de Parede", 18001, 25},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina dura", 18084, 30},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Leque", 19591, 3},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Porta de cofre", 19619, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Saída de incêndio", 11710, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Saída", 11711, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Placa de incêndio", 11710, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Placa de saída", 11711, 5},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Arara", 19079, 20},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina pequena fechada", 2358, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina pequena aberta", 2359, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina grande aberta", 2560, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina grande fechada", 2561, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Banheiro publico", 2984, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Banheiro publico 2", 3504, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Baixo", 19317, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Lareira", 11724, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Polly Dance", 19871, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Skate", 19878, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Espada", 19590, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cabeça de boi", 6865, 100},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Cortina pequena aberta", 14752, 30},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Ventilador de teto 3", 14527, 50},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Polly Dance 2", 3503, 10},
	{FURNITURE_CAT_DECOR, FURNITURE_SUBCAT_DECOR_OTHERS, "Barra de Ouro", 19941, 1000},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Esteira", 2627, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Supino", 2629, 90},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Supino complemento", 2916, 90},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bicicleta Ergométrica", 2630, 95},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de Basquete", 2114, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Mesa de Bilhar 1", 2964, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Mesa de Bilhar 2", 14651, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Saco de Pancada", 1985, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Aparelho de musculação", 2628, 150},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Halter 1", 3071, 80},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Halter 2", 3072, 80},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Halter pequeno", 2916, 50},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Sportsbag", 11745, 70},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de golfe", 1974, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Taco de sinuca", 3004, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Cesta de basquete com corpo", 946,50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Supino 2", 2913, 150},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa BRANCA", 3003, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 01", 3002, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 02", 3100, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 03", 3101, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 04", 3102, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 05", 3103, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 06", 3104, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 07", 3105, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca lisa 08", 3106, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 09", 2995, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 10", 2996, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 11", 2997, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 12", 2998, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 13", 2999, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 14", 3000, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Bola de sinuca listra 15", 3001, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_SPORT, "Luva de boxe", 19556, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão 27", 1518, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão c/ apoio", 1717, 55},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão antiga 15", 1747, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão antiga 20", 1748, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão 25", 1749, 45},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão antiga 21", 1750, 35},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão 30", 1752, 37},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão bem antiga", 1781, 20},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão moderna", 1791, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "LCD 25", 1792, 90},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "LCD 35", 2312, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão moderna", 2316, 95},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão antiga", 2317, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV tela plana ", 2318, 95},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV muito antiga", 2320, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Tela plana + Dvd", 2595, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV 25 branco e cinza", 1751, 45},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Plasma de 45", 1786, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV 30 branco e cinza", 2322, 35},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV 40 antiga", 2648, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "TV antiga 30", 14772, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão em estrutura 1", 16377, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão em estrutura 2", 14532, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão em estrutura 3", 14604, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão esférica", 2224, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão de parede 1", 2596, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão de parede 2", 2700, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão com speakers", 14806, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão em estante 1", 2296, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão em estante 2", 2297, 80},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão de LED 50", 19787, 300},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Televisão de LED 60", 19786, 350},
 	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_TELEVISION, "Conjunto de Monitores", 2606, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "Super Playbox", 1718, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "Tinsendo 1998", 1719, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "CJD 500", 2028, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "Maquina de Jogos 1", 2778, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_GAMES, "Maquina de Jogos 2", 2779, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "HI-DE DVD Player", 1782, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "DVR620 DVD Player", 1783, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Sunny DVD Player", 1785, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "BD655 Blu-Ray Player", 1787, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "BD670 Blu-Ray Player", 1788, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "DVR620 DVD Player", 1790, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Notebook aberto", 19893, 250},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Notebook fechado", 19894, 200},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Teclado", 19808, 40},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Fotocopiadora", 2202, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Antena", 2192, 90},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Controle-remoto", 2344, 5},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Caixa de Som Pequena 2", 2231, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Headset", 19422, 30},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MEDIA_PLAYER, "Kit DJ", 14820, 200},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Stereo system", 1809, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Hifi stereo", 1839, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Galvan stereo", 2101, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Caixa de som pequena", 1840, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Caixa de som grande", 2232, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Caixa de som home theater", 2233, 150},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Stereo stand system", 2104, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Caixa de som do stereo stand", 2229, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Jukebox", 1732, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Stereo system e caixas 1", 2099, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Stereo system e caixas 1", 2100, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Boombox retrô", 2102, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Boombox branca", 2103, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_STEREO, "Boombox original", 2226, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Telefone de parede", 11728, 80},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Telefone antigo", 11705, 70},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Telefone moderno", 19807, 100},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular antigo original", 330, 60},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular antigo preto", 2967, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular antigo azul", 2966, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular amarelo escuro", 18865, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular azul", 18866, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular laranja", 18867, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular preto", 18868, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular rosa", 18869, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular vermelho", 18870, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular verde", 18871, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular azul escuro", 18872, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular amarelo", 18873, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_PHONE, "Celular branco", 18874, 50},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Guitarra 1", 19318, 60},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Guitarra 2", 19319, 60},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Bateria", 19609, 70},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Cabeçote Guitarra", 19612, 60},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "Amplificador 1", 19613, 70},
	{FURNITURE_CAT_ENTERTAINMENT, FURNITURE_SUBCAT_MUSIC, "
 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Folha de alvo", 2058, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Folhas", 2059, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Saco de areia", 2060, 15},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Artilharia inutilizada", 2064, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Rede de camuflagem", 2068, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Porta relógio", 2710, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Painel de segurança", 19305, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Rolo de papel higiênico", 19873, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Chave", 11746, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cadeado", 19804, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Corrente", 2680, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Maleta primeiros-socorros", 11738, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cruz", 11712, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Rádio portátil", 19942, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Maço de cigarros CK", 19897, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Maço de cigarros", 19896, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Martelo", 18635, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixão", 19339, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Marreta", 19631, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Chave de fenda", 19627, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Mala velha", 19624, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cesta de compras", 19592, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Saco de carvão", 19573, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pager", 18875, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pé de quebra", 18634, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Lanterna", 18641, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Plano de aquitetura enrolado", 3017, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Quadro negro", 3077, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Bong", 2726, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Esfregão", 2712, 3},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pipa", 2499, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Barquinho de enfeite", 2484, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixas grandes", 1421, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Andaime 1", 1464, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Andaime 2", 1465, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Andaime 3", 1466, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cone", 1238, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pilha de madeiras", 1463, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Gaiola", 931, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Barril de Metal", 935,10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Escada", 1428, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Escada grande", 1437, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cadeira de rodas", 1369, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Tripé com antena", 3031, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Carro de boi", 1458, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Rolha de feno", 1454, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Carrinho de puxar malas", 1572, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Conjunto de mecânica", 11393, 5},
 	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixas empilhadas 1", 923, 5},
 	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixas empilhadas 2", 3015, 5},
 	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa grande aberta", 3796, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Câmera de Segurança", 2921, 80},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Câmera de Segurança 2", 1886, 100},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Foco de Luz Azul", 18658, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Foco de Luz Branco", 18656, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Foco de Luz Vermelha", 18657, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Fogo", 18688, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Giroflex", 18646, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Hairspray", 2752, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Hairspray 2", 2749, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Amarela", 19125, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Azul", 19122, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Azul Clara", 19126, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Branca", 19121, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Rosa", 19127, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Verde", 19123, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Luz Vermelha", 19124, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Amarelo", 18650, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Azul", 18648, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Branco", 18652, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Rosa", 18651, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Verde", 18649, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Neon Vermelho", 18647, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Ringue 1", 14781, 500},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Ringue 2", 14791, 500},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Lata de Sprunk", 2601, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Motor de carro", 19917, 400},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Carregador de pistola", 19995, 40},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Bandagem", 11747, 1},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Máquina de tatuagem", 2711, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Secador de cabelo", 2750, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa de ferramentas", 19921, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Dildos", 14666, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Casinha de cachorro", 1451, 20},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa de brinquedos", 2466, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa de brinquedos 2", 2465, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa de correios 2", 3407, 20},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Caixa de correios", 19867, 15},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pallet", 1448, 20},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Prancha", 2410, 50},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Bar Completo", 16151, 100},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Katana", 339, 500},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Sabonete", 19874, 5},
    {FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cavalinho balanço de madeira", 11733, 80},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Grade de cordas", 2945, 15},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Corda", 19087, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cortina Dura 2", 16732, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Fita Policial", 19834, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Elevador Completo", 18755, 10},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Cano", 19348, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Pneu Velho", 1025, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Fita policial", 19834, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Câmera 1", 19623, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Particula água caíndo", 18720, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Estrela do mar", 902, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Concha", 953, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Bola de praia", 1598, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Peixe", 1599, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Peixe azul", 1600, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Conjunto de peixes", 1601, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Peixe branco e azul", 1604, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Conjunto de peixes amarelos", 1605, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Conjunto de peixes azuis", 1606, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Golfinho", 1607, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Tubarão", 1608, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Tartaruga", 1609, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Água viva 1", 1603, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Água viva 2", 1602, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Concha 2", 2782, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Castelo de areia", 16103, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Alga", 903, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "Corrente de água", 19842, 5},
	{FURNITURE_CAT_MISC, FURNITURE_SUBCAT_MISC_OTHERS, "
 50},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_STAIR, "Escada baixa larga", 14394, 50},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca de ferro", 11474, 3},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca de madeira", 1446, 3},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca de Vidro", 3850, 50},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Grade Ferro", 997, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca VIP", 2773, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca Ferro 2", 970, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca braca de madeira", 1408, 5},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca Branca", 1553, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_FENCE, "Cerca de concreto", 19866, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_DRUG_SYSTEM, "Mesa de misturas", 19997, 5},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Arvore de Natal", 19076, 250},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Bolinha Branca", 19063, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Bolinha Amarela", 19062, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Bolinha Verde", 19061, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Bolinha Vermelha", 19060, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Bolinha Azul", 19059, 10},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Presente preto c/ laço azul", 19058, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Presente vermelho c/ laço amarelo", 19057, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Presente vermelho c/ laço branco", 19054, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Presente colorido c/ laço verde", 19056, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Presente amarelo c/ laço vermelho", 19055, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Fogueira (p/ lareiras)", 19632, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_XMAS, "Lâmpadas pisca-pisca vermelhas", 3038, 100},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Caveira", 1254, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Tocha de fogo", 3461, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Caveira flamejante", 3524, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Tocha de fogo p/ parede", 3525, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Corda com laço p/ enforcamento", 19088, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Corda", 19089, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Chifres do capiroto", 19314, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Abobora", 19320, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Cervo", 19315, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Cartola p/ abobora", 19352, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Calderião da bruxa", 19527, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Chápeu da bruxa", 19528, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Máscara p/ abobora", 19557, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Mancha de sangue falso", 19836, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Máscara do capiroto", 11704, 150},
	{FURNITURE_CAT_SPECIAL, FURNITURE_SUBCAT_HALLOWEEN, "Cruz", 11712, 150},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 1", 1049, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 2", 1060, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 3", 1163, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 4", 1158, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 5", 1147, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 6", 1146, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Aerofolio 7", 1164, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Para-Choque 1", 1151, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Para-Choque 2", 1152, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Para-Choque 3", 1180, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Para-Choque 4", 1150, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Para-Choque 5", 1178, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Escapamento 1", 1022, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Escapamento 2", 1021, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Escapamento 3", 1020, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Escapamento Duplo 1", 1019, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Escapamento Duplo 2", 1018, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Carro Coberto", 14826, 350},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Conjunto Garagem 1", 10282, 700},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Conjunto Garagem 2", 10282, 700},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Conjunto Garagem 3", 10282, 700},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Quadro de Ferramentas", 19815, 100},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Armario de Mecânica grande", 19899, 100},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Armario de Mecânica pequeno", 19900, 50},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Computador de Mecânica", 19903, 250},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Colete de Mecânico", 19904, 50},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Motor Velho", 19917, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Maleta de Ferramentas", 19921, 100},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Caixa de Ferramentas", 19918, 50},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Cilindro de Gás", 19816, 50},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Mini Quebra-molas", 19425, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Farol de Teto", 19280, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Chave de Roda", 18633, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Chave de Fenda", 18644, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Martelo", 18635, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Pé de Cabra", 18634, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Lanterna", 18641, 10},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Sucata de carro", 3593, 200},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Pneu Velho", 1327, 30},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Estante de Ferro", 2063, 100},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Cilindro de NOS 1", 1010, 30},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Cilindro de NOS 2", 1009, 30},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Cilindro de NOS 3", 1008, 30},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 1", 1083, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 2", 1084, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 3", 1076, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 4", 1077, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 5", 1078, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 6", 1098, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 7", 1097, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 8", 1082, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 9", 1085, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 10", 1096, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 11", 1075, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 12", 1074, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 13", 1080, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 14", 1073, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 15", 1079, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 16", 1081, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Roda 17", 1025, 500},
	{FURNITURE_CAT_EXCLUSIVE, FURNITURE_SUBCAT_GARAGE, "Plataforma amarela", 19872, 500}
};
