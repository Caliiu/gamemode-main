...
public OnPlayerSpawn(playerid)
{
	...
	if (!foundSpawn)
	{
		CharacterData[playerid][e_CHARACTER_POS][0] = 1760.9249;
		CharacterData[playerid][e_CHARACTER_POS][1] = -1877.5945;
		CharacterData[playerid][e_CHARACTER_POS][2] = 13.6007;
		CharacterData[playerid][e_CHARACTER_ANGLE] = 359.1800;
